...
# For getting review of the company "Accenture"
python main.py -u "https://www.glassdoor.co.in/Reviews/Accenture-Reviews-E4138.htm" -f "output-accenture.csv" --username -l 25 --headless
```